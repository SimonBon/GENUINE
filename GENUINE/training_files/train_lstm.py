from MICCAI.ModelZoo import LSTMClassifier
...
if __name__ == "__main__":
    ...
    model = LSTMClassifier("/home/simon_g/MICCAI/results/RetinaNet")
    ...
    ret_dict = train(200, model, train_loader, validation_loader, loss_fn, optimizer, save_dir="/home/simon_g/MICCAI/results/LSTM_ORDERED", use_gpu=True)